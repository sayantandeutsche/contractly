...
public class AccountService {
    ...
    public AccountDto create(CreateAccountRequest req) {
        ...
        a.setIndustry(req.getIndustry());
        a.setCustomerStatus(req.getCustomerStatus());
        a.setSegment(req.getSegment());
        a.setProfitCenter(req.getProfitCenter());
        a.setPhone(req.getPhone());
        a.setAccountEmail(req.getAccountEmail());
        a.setWebsite(req.getWebsite());
        a.setAccountNumber(req.getAccountNumber());
        a.setCurrencyIsoCode(req.getCurrencyIsoCode() != null ? req.getCurrencyIsoCode() : "USD");
        // Step 2
        a.setBillingStreet(req.getBillingStreet());
        a.setBillingCity(req.getBillingCity());
        a.setBillingState(req.getBillingState());
        a.setBillingPostalCode(req.getBillingPostalCode());
        a.setBillingCountry(req.getBillingCountry());
        a.setBillingCountryCode(req.getBillingCountryCode());
        // Step 3
        a.setNumberOfEmployees(req.getNumberOfEmployees());
        a.setNumberOfEmployeesRange(req.getNumberOfEmployeesRange());
        a.setAnnualRevenue(req.getAnnualRevenue());
        a.setOwnership(req.getOwnership());
        a.setRating(req.getRating());
        a.setSubscriptionStatus(req.getSubscriptionStatus());
